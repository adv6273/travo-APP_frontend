...
const ProfilePage = () => {
  ...
  Welcome <span style={{ fontWeight: 'bold' }}>{user.name}</span> to travo-APP
    ...
    <button
      className="inline-block cursor-pointer rounded-md bg-primary px-4 py-3 mt-10 text-center text-sm font-semibold uppercase text-white transition duration-200 ease-in-out hover:bg-gray-900" onClick={handleLogout}
    >
      logout
    </button>
  </div>
