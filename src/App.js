      ...
      <Router>
        ...
        <Layout>
          <Routes>
            ...
            <Route path="/acounts/:subpage?" element={<Acounts />} />
            <Route path="/acounts/myBookings" element={<BookingsPage />} />
            <Route path="/acounts/bookingReq" element={<BookingRequests />} />
            <Route path="/acounts/myBookings/:id" element={<SingleBookingPage />} />
            <Route path="/acounts/myAccommodation/new/:id" element={<AddNewPlace />} />
            <Route path="/places/detail/:id" element={<EditForm />} />
